...
# assemblydir = ('C:/Users/brile/source/repos/Dionne_Lab/photoreactor/Equipment/'
#                'SRI_GC/PeaksimpleClient')

assemblydir = (r'C:\\Program Files\\Added Programs\\PeakSimple_Control\\'
               'PeakSimple_Control_Demo\\PeaksimpleClient\\PeaksimpleConnector.dll')
